...
export default class DB {
  ...
  observeProjects() {
    ...
    try {
      ...
      const watchErrorUrl = 'https://github.com/atom/atom/blob/master/docs/build-instructions/linux.md#typeerror-unable-to-watch-path';
  ...
  readFile(callback) {
    fs.exists(this.file(), (exists) => {
      if (exists) {
        ...
        fs.writeFile(this.file(), '{}', (error) => callback({}));
      }
    });
  }
