...
export default class Project {
  ...
  @computed get aheadBehindCount() {
    if (this.props.repository.isDestroyed()) {
      throw new Error('Your repository is destroyed?');
    }
    const ref = this.props.repository.getShortHead();
    return this.props.repository.getAheadBehindCount(ref);
  }
